...
// @updateURL http://reeksite.com/anti-adblock-killer/anti-adblock-killer.user.js
// @downloadURL http://reeksite.com/anti-adblock-killer/anti-adblock-killer.user.js
// @include http://*/*
// @include https://*/*
// @grant unsafeWindow
// @grant GM_addStyle
    ...
    notification : function (message, delay) {
      if (Aak.isTopframe) {
        ...
        Aak.createElement({
          tag : 'iframe',
          id : 'aak-notice-frame',
          style : 'position:fixed; z-index:9999999999; top:10px; left:10px;',
          width : '360px',
          height : '120px',
          frameborder : 0,
          scrolling : 'no',
